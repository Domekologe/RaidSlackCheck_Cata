rscspisokid={{79063,79061},{79105},{79107},{79038,79058},{79102}}
...
--txt main
	...
	rsctxttitlemain:SetFont(GameFontNormal:GetFont(), rscfontsset[2], 'MONOCHROME')
	...
	tt:SetFont(GameFontNormal:GetFont(), rscfontsset[2], 'MONOCHROME')
...
--5 checkbox
	...
	local pii=-72
	for ii=1,5 do
	local rsccheckbox1 = CreateFrame("CheckButton", nil, rscframetoshowall5, "InterfaceOptionsCheckButtonTemplate")
...
--5 text
	...
	rsctextaddnon:SetFont(GameFontNormal:GetFont(), rscfontsset[2], 'MONOCHROME')
...
for i=1,#rscspisokid do
	...
	--checkbuttons
	local c = CreateFrame("CheckButton", nil, rscframetoshowall5, "InterfaceOptionsCheckButtonTemplate")
	c:SetWidth("25")
	c:SetHeight("25")
	...
	for as=1,#rscspisokid[i] do
		local aaname2, _, aaicon2=C_Spell.GetSpellInfo(rscspisokid[i][as])
		if aaname2 then
	...
	t:SetFont(GameFontNormal:GetFont(), rscfontsset[2], 'MONOCHROME')
	t:SetText(aaname)
	t:SetJustifyH("LEFT")
