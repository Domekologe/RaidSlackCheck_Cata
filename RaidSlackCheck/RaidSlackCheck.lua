...
--rscignorezonedef={{1490,1491,1493,1494,1497,1512,1513,1514,1515,1516,1517,1518,1519,1520,1580,1581,1582,1590,1591,1592,1593,1594,1595,1596,1597},{"Mechagon","Mechagon","Mechagon","Mechagon","Mechagon","The Eternal Palace","The Eternal Palace","The Eternal Palace","The Eternal Palace","The Eternal Palace","The Eternal Palace","The Eternal Palace","The Eternal Palace","The Eternal Palace","Ny'alotha","Ny'alotha","Ny'alotha","Ny'alotha","Ny'alotha","Ny'alotha","Ny'alotha","Ny'alotha","Ny'alotha","Ny'alotha","Ny'alotha"}} -- беру от сюда https://wow.gamepedia.com/UiMapID

rscignorezonedef={{752,754,824,800,758,773},{"Baradin Hold", "Blackwing Descent","Dragon Soul","Firelands","The Bastion of Twilight","Throne of the Four Winds"}}
...
87554, --Goblin Barbecue --60
87555, --Goblin Barbecue --60
87556, --Goblin Barbecue --60
87557, --Goblin Barbecue --60
87558, --Goblin Barbecue --60
87559, --Goblin Barbecue --60
87560, --Goblin Barbecue --60
87561, --Goblin Barbecue --60
87562, --Goblin Barbecue --60
87563, --Goblin Barbecue --60
87564, --Goblin Barbecue --60
87565, --Goblin Barbecue --60
...
--==============FLASKS===============
rscflasktable={
	92731, --Flask of Battle
	92730, --Flask of Battle
	92729, --Flask of Battle
	92725, --Flask of Battle
		...
		for yy=1,#rscrebirth3 do
			if rscrebirth3[yy] and curtime>rscrebirth3[yy] then
				...
				if UnitIsDeadOrGhost(rscrebirth2[yy])==false and UnitAffectingCombat(rscrebirth2[yy]) and rscbuffcheckb2[1]==1 and (rscbuffcheckb2[2]==1 or rscbuffcheckb2[3]==1 or rscbuffcheckb2[4]==1 or rscbuffcheckb2[5]==1) and (rscbcanannounce==nil or (rscbcanannounce and GetTime()>rscbcanannounce+180)) then
					...
					local tablid={{20217,1126,90363},{6307,469,21562,90364},{20043,8184,19891,27683},{1459,61316},{19740}} --ид бафов
					local buffnamelist={rscbuffnameslitnew1,rscbuffnameslitnew2,rscbuffnameslitnew4,rscbuffnameslitnew5}
					local classesnorm={{"PALADIN","DRUID"},{"PRIEST"},{"PRIEST"},{"MAGE"},{"PALADIN"}}
					...
					for x=1,#rscspisokid do
						if rscbuffwhichtrack2[x]==1 then
							local byl=0
							for z=1,#tablid[x] do
								local spbuf=C_Spell.GetSpellInfo(tablid[x][z])
								if spbuf and checkBuff(rscrebirth2[yy],spbuf) then--UnitBuff(rscrebirth2[yy], spbuf) then
									byl=1
								end
							end
		...
		for yy=1,#rscrebirth5 do
			if rscrebirth5[yy] and curtime>rscrebirth5[yy] then
				...
				if UnitIsDeadOrGhost(rscrebirth4[yy])==false and UnitAffectingCombat(rscrebirth4[yy]) and rscbuffcheckb2[1]==1 and (rscbuffcheckb2[3]==1 or rscbuffcheckb2[5]==1) and (rscbcanannounce==nil or (rscbcanannounce and GetTime()>rscbcanannounce+180)) then
					...
					--1 модуль для всех
					local tablid={{20217,1126,90363},{6307,469,21562,90364},{20043,8184,19891,27683},{1459,61316},{19740}} --ид бафов
					local buffnamelist={rscbuffnameslitnew1,rscbuffnameslitnew2,rscbuffnameslitnew3,rscbuffnameslitnew4,rscbuffnameslitnew5}
					local classesnorm={{"PALADIN","DRUID"},{"PRIEST"},{"PRIEST"},{"MAGE"},{"PALADIN"}}
					local buffnotneed={{}, {}, {}, {"ROGUE","HUNTER","WARRIOR","DEATHKNIGHT"},{}} --не нужны бафы кому
					...
					for x=1,#rscspisokid do
						if rscbuffwhichtrack2[x]==1 then
							...
							for z=1,#tablid[x] do
								local spbuf=C_Spell.GetSpellInfo(tablid[x][z])
								if spbuf and checkBuff(rscrebirth4[yy],spbuf) then--UnitBuff(rscrebirth4[yy], spbuf) then
									byl=1
								end
							end
...
if rscignorezone20==nil then
	rscignorezone20={{},{}}
	for i=1,#rscignorezonedef[1] do
		table.insert(rscignorezone20[1],rscignorezonedef[1][i])
		table.insert(rscignorezone20[2],rscignorezonedef[2][i])
	end
...
C_ChatInfo.RegisterAddonMessagePrefix ("RSCaddon")
C_ChatInfo.RegisterAddonMessagePrefix ("PSaddon")
...
if arg2=="SPELL_CREATE" and arg5 and UnitInRaid(arg5) then
    ...
    local addtext=""
		...
		if rscdelayannouncecheck1==nil or (rscdelayannouncecheck1 and GetTime()>rscdelayannouncecheck1+50) then
			...
			if select(3,GetInstanceInfo())==17 or IsLFGModeActive(LE_LFG_CATEGORY_LFD) then
			C_ChatInfo.SendAddonMessage("RSCaddon", "c"..stxt, "Instance_CHAT")
			else
			C_ChatInfo.SendAddonMessage("RSCaddon", "c"..stxt, "RAID")
			end
...
if arg2=="SPELL_CAST_START" and arg5 and UnitInRaid(arg5) then
	if rsctableannounce[2]==1 then
		...
		if rscdelayannouncecheck2==nil or (rscdelayannouncecheck2 and GetTime()>rscdelayannouncecheck2+50) then
			...
			if select(3,GetInstanceInfo())==17 or IsLFGModeActive(LE_LFG_CATEGORY_LFD) then
			--C_ChatInfo.SendAddonMessage("RSCaddon", "d"..stxt, "Instance_CHAT")
			else
			C_ChatInfo.SendAddonMessage("RSCaddon", "d"..stxt, "RAID")
			end
...
if arg2=="SPELL_SUMMON" and arg5 and UnitInRaid(arg5) then
	if rsctableannounce[3]==1 then
		...
		if rscdelayannouncecheck3==nil or (rscdelayannouncecheck3 and GetTime()>rscdelayannouncecheck3+50) then
			...
			if select(3,GetInstanceInfo())==17 or IsLFGModeActive(LE_LFG_CATEGORY_LFD) then
			--C_ChatInfo.SendAddonMessage("RSCaddon", "e"..stxt, "Instance_CHAT")
			else
			C_ChatInfo.SendAddonMessage("RSCaddon", "e"..stxt, "RAID")
			end
...
if arg2=="SPELL_CREATE" and arg5 and UnitInRaid(arg5) then
	if rsctableannounce[4]==1 then
		...
		if rscdelayannouncecheck4==nil or (rscdelayannouncecheck4 and GetTime()>rscdelayannouncecheck4+50) then
			...
			if select(3,GetInstanceInfo())==17 or IsLFGModeActive(LE_LFG_CATEGORY_LFD) then
			--C_ChatInfo.SendAddonMessage("RSCaddon", "f"..stxt, "Instance_CHAT")
			else
			C_ChatInfo.SendAddonMessage("RSCaddon", "f"..stxt, "RAID")
			end
...
if select(3,GetInstanceInfo())==17 or IsLFGModeActive(LE_LFG_CATEGORY_LFD) then
--C_ChatInfo.SendAddonMessage("RSCaddon", "2"..stxt, "Instance_CHAT")
else
C_ChatInfo.SendAddonMessage("RSCaddon", "2"..stxt, "RAID")
end
	end
...
rscreporttxt:SetFont(GameFontNormal:GetFont(), 14, 'MONOCHROME')
rscreporttxt:SetText(rsclocrep1)
rscreporttxt:SetJustifyH("LEFT")
rscreporttxt:SetPoint("TOPLEFT",565,-150)

rscreporttxt2:SetFont(GameFontNormal:GetFont(), rscfontsset[2], 'MONOCHROME')
...
rschsnumtxt1:SetFont(GameFontNormal:GetFont(), 14, 'MONOCHROME')
rschsnumtxt1:SetText("")
rschsnumtxt1:SetJustifyH("RIGHT")
rschsnumtxt1:SetWidth(50)
rschsnumtxt1:SetPoint("TOPLEFT",495,-407)

rschsnumtxt2:SetFont(GameFontNormal:GetFont(), 14, 'MONOCHROME')
...
rschsnumtxt3:SetFont(GameFontNormal:GetFont(), 14, 'MONOCHROME')
rschsnumtxt3:SetText("")
rschsnumtxt3:SetJustifyH("RIGHT")
rschsnumtxt3:SetWidth(50)
rschsnumtxt3:SetPoint("TOPLEFT",495,-247)

rschsnumtxt4:SetFont(GameFontNormal:GetFont(), 14, 'MONOCHROME')
...
local rscspellname=C_Spell.GetSpellInfo(tonumber(string.sub(rscpotioninfotable[numr][i],string.find(rscpotioninfotable[numr][i], "++")+4)))
...
local rscspellname=C_Spell.GetSpellInfo(tonumber(string.sub(rscpotionnotincombat[i],string.find(rscpotionnotincombat[i], "!!")+4)))
...
local rscspellname2=C_Spell.GetSpellInfo(tonumber(string.sub(rscpotioninfotable[numrboy][i],string.find(rscpotioninfotable[numrboy][i], "++")+4)))
...
local rscspellname=C_Spell.GetSpellInfo(tonumber(string.sub(rscpotioninfotable[numrboy][i],string.find(rscpotioninfotable[numrboy][i], "++")+4)))
...
local rscspellname=C_Spell.GetSpellInfo(tonumber(string.sub(rscotherpotdrunk[i],string.find(rscotherpotdrunk[i], "++")+4)))
